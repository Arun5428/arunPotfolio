...
const Hero = () => {
  ...
  <h1 className={`${styles.heroHeadText}
   text-white`}> Hi, I'm Backend <span className='text-[#915eff]'>
     <TypeWriterEffect
   ...
   <p className={`${styles.heroSubText} mt-2 text-white-100`}>
    I develop java web application <br className='sm:block hidden'/> and also spring boot and react application 
